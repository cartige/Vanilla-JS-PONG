class Game{
    constructor(maxWidth, maxHeight){
        ...
        this._ball = new Ball(90, 1, -0.5, 0.5, 2.7*maxHeight/100); //2.7% de maxHeight
    ...
    resetBall(){
        this._ball.positionX = 50;
        this._ball.positionY = 30;
        this._ball.vectorX = 0.5;
        this._ball.vectorY = 0.5;
    }
    nextBallPosition(){
